...
@app.route('/java')
def java():
    return render_template("homesite/java.html")

@app.route('/java/hello')
def javahello():
    return render_template("homesite/project.html", data=java_hello())

@app.route('/java/mvc')
def javamvc():
    return render_template("homesite/project.html", data=java_mvc())

@app.route('/java/ap')
def javaap():
    return render_template("homesite/project.html", data=java_ap())

@app.route('/python')
def python():
    return render_template("homesite/python.html")
...
@app.route('/python/ap')
def pythonap():
    return render_template("homesite/project.html", data=python_ap())

@app.route('/about')
def about():
    return render_template("homesite/about.html")